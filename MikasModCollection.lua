...
function SMODS.INIT.MikasModCollection()
    ...
    if config.taxCollectorJoker then
        ...
        local tax_collector = {
            loc = {
                ...
                text = {
                    ...
                    "at end of round",
                    "Gives {C:dark_edition}$#3#",
                    "if the joker is {C:dark_edition}modded",
                    "instead"
                }
            },
        ...
        function SMODS.Jokers.j_mmc_tax_collector.loc_def(card)
            return { card.ability.extra.dollars, card.ability.extra.dollars * 2, card.ability.extra.dollars * 4, card.ability.extra.dollars * 3 } -- uncommon - $1, rare - $2, legendary - $4, other - $3
        end
